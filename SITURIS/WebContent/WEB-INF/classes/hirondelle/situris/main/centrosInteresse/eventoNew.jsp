...
<body onload="load()" onunload="GUnload()">
	...
	<c:set value='EventoNewAction.apply' var='baseURL' />
	<w:txtFlow>
        ...
        <tr>
          ...
          <td><input name="ImageFile" type="file"></td>
				...
				<tr>
					...
					<td><input name="DataInicio" type="text"> (YYYYMMDD)</td>
				</tr>
				<tr>
					<td><label>End Date</label></td>
					<td><input name="DataFim" type="text"> (YYYYMMDD)</td>
				</tr>
				<tr>
					<td><label>Interest Type</label></td>
					<td><select name="TipoInteresse">
							<c:forEach var="itemsListing1" items="${itemsForListing}"
								varStatus="index">
								<option value='${itemsListing1.idTipoInteresse}'>${itemsListing1.descricaoTI}</option>
							</c:forEach>
					</select></td>
				</tr>
				<tr>
