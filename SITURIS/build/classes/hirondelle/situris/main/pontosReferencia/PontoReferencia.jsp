...
<script type="text/javascript">
	function load() {
		if (GBrowserIsCompatible()) {
			...
			var center = new GLatLng(document.getElementById("lat").value,
			...
			geocoder.getLatLng(address, function(point) {
				if (!point) {
					...
					GEvent.addListener(marker, "dragend", function() {
						...
						document.getElementById("long").value = pt.lng();
					});
...
<body onload="load()" onunload="GUnload()">
	...
	<form action="#"
		...
		<input type="text" size="34" name="address" value="" /> <input
	...
	<c:set value='GestaoPtRefAction.change' var='baseURL' />
	<w:txtFlow>
		<w:populate using="itemForEdit">
			<form action='${baseURL}' method="post" class="user-input">
				<input name="IdPtRef" type="hidden">
				<table align="center">
					<tr>
